      ...
      <div className="w-full bg-white rounded-lg shadow-2xl md:mt-0 sm:max-w-md xl:p-0">
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit(onSubmit)}>
                  ...
                  <Button type="submit" size={'3'} className="w-full text-md text-white bg-primary-600 font-medium text-sm !px-6 !py-5 text-center">Sign in</Button>
                  ...
                  <button onClick={() => signIn('google')} className="flex w-full items-center justify-center gap-3 bg-white border border-gray-300 rounded-lg shadow-md px-6 py-2 text-md font-medium text-gray-800 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
